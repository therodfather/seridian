    ...
    <div className="relative">
      ...
      {open && (
        <div
          ...
          ref={panelRef}
          // Anchor above the footer status-bar control — `top-full` renders off-screen.
          className="absolute right-0 bottom-full z-50 mb-2 w-80 overflow-hidden rounded-xl border border-white/[0.06] bg-[#0c1222] shadow-2xl shadow-black/40"
          role="dialog"
